...
model = genai.GenerativeModel("gemini-2.5-flash") # Google AI Studio
...
async def ask_ziva(body: Ask):
    response = model.generate_content(f"Você é a ZIVA, IA da rede social. Responda em pt-BR, curto: {body.prompt}")
